...
namespace PureCSharpAssignment1.Tests
{
    public class DamageCalculationTests
    {
        ...
        [Fact]
        public void HeroBarbarianDamage_NoWeaponEquipped_ShouldBeCorrect()
        {
            // Arrange
            var barbarian = new Barbarian("Conan");
        ...
        [Fact]
        public void HeroBarbarianDamage_WithWeaponEquipped_ShouldBeCorrect()
        {
            // Arrange
            var barbarian = new Barbarian("Conan");
            var hatchet = new Weapon("Common Hatchet", 1, WeaponType.HATCHETS, 2);
        ...
        [Fact]
        public void HeroBarbarianDamage_WithWeaponAndArmorEquipped_ShouldBeCorrect()
        {
            // Arrange
            var barbarian = new Barbarian("Conan");
            var hatchet = new Weapon("Common Hatchet", 1, WeaponType.HATCHETS, 2);
